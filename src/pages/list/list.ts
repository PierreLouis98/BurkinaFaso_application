...
export class ListPage 
{
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams) 
     ...
     [['1. Quelle quantité de semences pour 1 ha de niébé en culture pure ?','A. 3 kg de semences', 'B. 40 kg de semences','C. 60 kg de semences','D. 12  à 25 kg de semences'], 
     ['2. Quels critères tient-on compte dans le choix de la variété','a. Le choix de la variété doit tenir compte de la durée du cycle cultural, du potentiel de rendement et des contraintes biotiques et abiotiques de la zone de production','b. Le choix de la variété doit tenir exclusivement compte de son accessibilité (prix,disponibilité…)','c. Le choix de la variété doit tenir uniquement compte des opportunités de revente du niébé','d. Toutes les reponses sont vraies'], 
     ['3. Laquelle de ces variétes de niébé, possède le cycle de production le plus court','A. IT 98 K-205-8','B. IT 90 K-372-1-2','C. KVX-30-309-6G','D.IT99 K-573-1-1'], 
     ['4. Parmi les variétés suivantes laquelle est  semi-rampante ?','A. IT 98 K-205-8','B.IT99 K-573-1-1','c. IT 97 K-499-38','D. IT 97 K-499-35'],
     ['5. Question : laquelle de ces variétés possède le meilleur  rendement ?', 'a. IT99 K-573-1-1', 'b. IT 98 K-205-8', 'c. IT96D-610-', 'd.  IT 97 K-499-38'], 
     ['6. Laquelle de ces variétés tolère mieux la sécheresse', 'A. IT99 K-573-1-1 ', 'B. IT 98 K-205-8 ', 'C. IT96D-610- ', 'D. IT 97 K-499-38 '], 
     [ '7.Quel traitement des semences avant le semi ?', 'a Il faut traiter la semence avec le calthio contre les insectes et les maladies avant de semer', 'b Il n’est pas necessaire de faire un traitement des semences avant le semis', 'c Il faudrait traiter les semences avec le decis avant les semis ', 'd Toutes les reponses précédemment proposées sont vraies' ]
     ]];
...
/** TABLEAU A DEUX DIMENSIONS */
      ...
      /** Tableau d'item contenant le tableau d'icon, de note et de titre */
        this.items = [];
        for (var i = 0; i < 2; i++)
            this.items.push({ reponse: this.reponses[i], ind: this.index[i], title: this.titles[0] + (i+1), note: this.notes[i] , question: this.questions[i]  }); 
